 ...
 */
public class Parqueadero extends Carro{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
    ...
    public String metodo1() {
        int llamar = darHoraLlegada() + darHoraActual();
        System.out.println(llamar);
        int mayor = 0;
        String placamayortiempo = "";

        for (Puesto p : puestos) {
            if (p.estaOcupado() && llamar > mayor) {
                System.out.println(llamar);
                mayor = llamar;
                placamayortiempo = p.darCarro().darPlaca();
            }
        }
        System.out.println(placamayortiempo);
        return ("La placa que lleva mas tiempo es: " + placamayortiempo);
    }
